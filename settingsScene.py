...
class SettingsScene(object):
    ...
    def create_labels(self, root: Component)->None:
        ...
        self.soundFX = Label(text = "Adjust Sound FX", rect=Rect(150, 120, 250, 50),
                                style=Style(
        ...
        self.full_screen = Label(text = "Full Screen Mode", rect=Rect(200, 300, 200, 100),
                                style=Style(
                                    background_color=(0, 128, 255),
                                    color=(245, 255, 255)),
                                parent=root)
    ...
    def create_sliders(self, root: Component)->None:
        ...
        self.soundFX_slider = Slider(on_value_changed=self.change_volume,
                                  ...
                                  style=Style(background_color= (102, 0, 102), color=(255, 255, 204)),
                                  parent=root)
